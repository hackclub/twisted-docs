...
---
> As you create hardware projects for Twisted, you will be required to include a BOM, or Bill of Materials, in .csv format. If you have any questions or suggestions, reach out in #hardware or DM @Tanishq Goyal!
...
![Manufactoring BOM Example!](https://twisted.hackclub-assets.com/docs/Hardware/Resources/bom/fbea41efef552a6cc8830f589c44f6f3f2b8e236_pasted_image_20251017223635.webp)
> This is is what industry BOMs look like. Thankfully, you won't have to deal with that for Twisted! This format is pretty widespread, with robotics teams listing parts similarly as well. 

However, for Twisted, your BOMs will look vastly different and is much less complex.  Here are the bare minimums for what you need for your Twisted BOM:
...
![Step_1](https://twisted.hackclub-assets.com/docs/Hardware/Resources/bom/19deaef50d30d1524066970c1b76a219ad170939_pasted_image_20251017234942.webp)
...
- **First Item:** `=ROUND(Total Price × 1.06625, 2)`
  ...
  - ![roundingexample.0](https://twisted.hackclub-assets.com/docs/Hardware/Resources/bom/85f4db06f3ed14e960764b7143931e6875eed6f3_pasted_image_20251018003730.webp)
- **Subsequent Items:** `=ROUND(Total Price × 1.06625, 2) + Previous Running Total`
  - **Example:** `=ROUND(D3*1.06625,2)+G2`
  - ![roundingexample.1](https://twisted.hackclub-assets.com/docs/Hardware/Resources/bom/2905b4cb99a86be967c7144cf6372dd936f00b04_pasted_image_20251018003712.webp)
...
![BOM](https://twisted.hackclub-assets.com/docs/Hardware/Resources/bom/3479c9e12046945013728171f0a0e4d705464fd1_image.webp)
