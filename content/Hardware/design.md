...
We’re here to help\! But we can’t tell you exactly what to do. Before directly reaching out to us, read our documentation, ask in #hardware or #twisted, Google it!
...
A project that only you can make is not [**shipped**](/Hardware/shipping). It only lives in your head.
